  ...
  <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
    ...
    <div class="flex items-center gap-2">
      ...
      <button
        ...
        class="flex items-center gap-2 px-3 py-1.5 bg-secondary text-secondary-foreground rounded-lg hover:bg-hover transition-colors"
      ...
      >
        ...
        {#if hasActiveFilters}
          <span class="px-1.5 py-0.5 bg-primary text-primary-foreground text-xs font-bold rounded-full">
