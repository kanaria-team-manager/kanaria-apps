  ...
  <div class="min-h-screen bg-gradient-to-br from-background to-muted flex">
	...
	<div class="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
	  <div class="w-full max-w-md">
		<!-- Header -->
		<div class="mb-8">
		  <h1 class="text-3xl font-bold text-foreground">アカウント作成</h1>
		  <p class="text-muted-foreground mt-2">Kanariaで、チーム運営をもっと簡単に。</p>
		</div>
		...
		<div class="bg-card rounded-lg shadow-lg border border-border p-8">
		  ...
		  <div class="mt-6 text-center text-sm">
			<span class="text-muted-foreground">すでにアカウントをお持ちですか？ </span>
	...
	<div class="hidden lg:flex w-1/2 bg-primary items-center justify-center p-12">
	  <div class="max-w-lg text-primary-foreground">
		...
		<!-- Features -->
		<h2 class="text-2xl font-bold mb-6">少年少女サッカーチームの運営をサポート</h2>
		...
		<ul class="space-y-4">
		  <li class="flex items-start gap-3">
			...
			<div>
			  ...
			  <p class="text-sm text-primary-foreground/80">練習・試合の予定を簡単に共有。出欠確認も楽々！</p>
			</div>
		  </li>
		  <li class="flex items-start gap-3">
			<div class="w-6 h-6 rounded-full bg-primary-foreground/20 flex items-center justify-center flex-shrink-0 mt-0.5">
			...
			<div>
			  ...
			  <p class="text-sm text-primary-foreground/80">コーチから保護者への連絡がスムーズに。既読確認も可能。</p>
			</div>
		  </li>
		  <li class="flex items-start gap-3">
			<div class="w-6 h-6 rounded-full bg-primary-foreground/20 flex items-center justify-center flex-shrink-0 mt-0.5">
			...
			<div>
			  ...
			  <p class="text-sm text-primary-foreground/80">選手情報を一元管理。成長記録や出席率も把握できます。</p>
			</div>
		  </li>
		</ul>
